package com.soongan.soonganbackend.soongansupport.jasypt

import com.soongan.soonganbackend.soongansupport.config.JasyptEncryptor
...
@SpringBootTest(classes = [JasyptEncryptor::class])
class JasyptTest {
